...
(() => {
 ...
 const STRINGS={
  ...
  exportUnpaid:'Secure checkout. Your full-quality master arrives by email.',
  exportReady:'Payment complete. Enter your email to receive your download link.',
  exportDemoUnpaid:'Try the checkout flow. Your master arrives by email only.',
