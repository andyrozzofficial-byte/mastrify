...
export default function HowItWorksClient() {
  ...
  return (
    <MarketingPageFrame>
      ...
      <MarketingSection bordered compact contained>
        ...
        <motion.div
          className="marketing-card-grid mt-8 md:mt-9"
          initial="hidden"
          whileInView="visible"
      ...
      <MarketingSection compact contained>
        <div className="marketing-philosophy-panel">
          <Reveal>
            ...
            <p className="mt-4 max-w-2xl text-[14px] leading-relaxed text-white/72 md:text-[15px]">
              Great mastering is often about what you choose not to do. Mastrify earns each move of the chain — so punch,
              space, and emotion survive the journey to release.
            </p>
          </Reveal>

          <div className="marketing-card-grid mt-8 md:mt-9">
      ...
      <MarketingSection bordered compact contained>
        <div className="marketing-split-grid grid gap-8">
          <Reveal>
            ...
            <p className="mt-4 text-[14px] leading-relaxed text-white/72 md:text-[15px]">
              Clean, unclipped mixes with some dynamic space usually produce the most transparent masters. You do not need
              to hit a specific peak level — just avoid slamming the bus if you want the most open result.
            </p>
            <p className="mt-4 text-[14px] leading-relaxed text-white/68 md:text-[15px]">
              Already heavily limited or loud? That is fine. The engine reads the material and adapts — supporting what is
      ...
      <MarketingSection compact contained bordered className="marketing-trust-close !pt-6 md:!pt-8">
        <Reveal className="text-center">
        ...
        <Reveal delay={0.08} className="mt-6 flex flex-wrap justify-center gap-2 md:gap-2.5">
          {TRUST.map((label) => (
            <span
              key={label}
