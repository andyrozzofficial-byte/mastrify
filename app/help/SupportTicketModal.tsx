...
import { TicketFormFrame } from "../components/content/ContentPageLayout"
...
export default function SupportTicketModal({
  ...
  return (
    <AnimatePresence>
      {open ? (
        <div className="fixed inset-0 z-[80] flex items-start justify-center overflow-y-auto px-5 py-6 sm:px-8 sm:py-10">
          <motion.button
            type="button"
          ...
          <motion.div
            ...
            className="relative z-10 my-auto w-full max-w-[700px] overflow-hidden rounded-[1.35rem] border border-white/[0.12] bg-gradient-to-b from-[#121218] to-black shadow-[0_24px_80px_rgba(0,0,0,0.55),0_0_0_1px_rgba(167,139,250,0.1)] max-sm:fixed max-sm:inset-x-0 max-sm:bottom-0 max-sm:my-0 max-sm:max-h-[min(92vh,820px)] max-sm:rounded-b-none max-sm:rounded-t-[1.35rem]"
          ...
          >
            ...
            <div className="max-h-[min(72vh,720px)] overflow-y-auto px-5 py-5 sm:px-6 sm:py-6">
              <TicketFormFrame>
                {ticketSuccess ? (
