  ...
  return (
    <section className="mt-12 flex min-h-[120px] w-full items-center justify-between gap-8 rounded-3xl border border-white/[0.1] bg-gradient-to-b from-white/[0.05] to-black/[0.75] p-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.07)] max-sm:flex-col max-sm:items-start">
      ...
      <button
        ...
        className="inline-flex shrink-0 self-center min-h-[46px] items-center justify-center rounded-xl bg-gradient-to-b from-violet-500/95 via-indigo-600/95 to-indigo-800/95 px-7 text-[13px] font-semibold text-white shadow-[0_14px_36px_rgba(0,0,0,0.38)] ring-1 ring-white/[0.1] transition hover:brightness-[1.04]"
      >
