...
export default function MasteringEngineVisual({ activeStep, className }: Props) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="pointer-events-none absolute inset-[-22%] rounded-full bg-[radial-gradient(circle,rgba(99,102,241,0.22)_0%,transparent_62%)] blur-3xl"
        animate={
          reduceMotion
            ? { opacity: 0.5 }
      ...
      />
      <motion.div
        className="pointer-events-none absolute inset-[-12%] rounded-full bg-[radial-gradient(circle_at_30%_40%,rgba(34,211,238,0.12),transparent_55%)] blur-2xl"
