...
export default function MasterProcessingPage() {
  ...
  return (
    <MarketingPageFrame workstation>
      <div className="page-container product-flow-page-bottom w-full">
      <div className={`product-processing-view product-processing-view--workstation ${reduce ? "" : "product-processing-view--enter"}`}>
        <header className="product-processing-header">
          <span className="rounded-full border border-white/[0.08] bg-white/[0.03] px-3.5 py-1 text-[10px] font-semibold uppercase tracking-[0.22em] text-white/55">
            Mastering
          </span>
          <div className="product-processing-header__copy">
            <p className="mt-4 text-[11px] font-medium uppercase tracking-[0.24em] text-white/42 md:text-xs">
              Signal chain active
            </p>
            <h1 className="mt-2 text-[1.5rem] font-semibold leading-[1.15] tracking-[-0.02em] text-white sm:text-[1.75rem] md:text-[2rem]">
              Rendering your master
            </h1>
            <p className="mx-auto mt-2.5 max-w-md text-[14px] leading-relaxed text-white/62 md:text-[15px]">
              Analyzing dynamics, EQ balance, and stereo image — typically under a minute.
            </p>
          </div>
        </header>
