...
export type AnalyzePhase = "upload" | "analyzing" | "results"
...
function stepIndex(phase: AnalyzePhase): number {
  if (phase === "upload") return 0
  if (phase === "analyzing") return 1
  return 2
}

export default function AnalyzeStepRail({ phase, className = "" }: Props) {
              ...
              <motion.div
                ...
                animate={
                  reduce
                    ? undefined
                    : {
                        opacity: active >= i ? [0.35, 0.65, 0.35] : 0.25,
                      }
                }
