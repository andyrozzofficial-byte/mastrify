...
export default function AnalyzeResultsCta({ canMaster, onMaster, onFlow }: Props) {
  ...
  return (
    <motion.div
      ...
      className="relative"
    >
      <motion.div className="panel-surface glass-surface relative overflow-hidden rounded-xl border border-violet-400/[0.14] bg-gradient-to-br from-violet-950/42 via-black/60 to-slate-950/48 px-4 py-4 md:flex md:items-center md:justify-between md:gap-6 md:px-5 md:py-4">
        <div
