...
export default function CinematicBackground({ intensity = "default" }: { intensity?: "default" | "subtle" | "strong" }) {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      />
      <div className="absolute left-1/2 top-[-200px] h-[520px] w-[min(900px,150vw)] -translate-x-1/2 rounded-full bg-purple-500/[0.055] blur-[110px]" />
      <div className="absolute bottom-[-240px] left-1/2 h-[560px] w-[min(780px,145vw)] -translate-x-1/2 rounded-full bg-cyan-500/[0.035] blur-[120px]" />
