...
export default function CinematicBackground({ intensity = "default" }: { intensity?: "default" | "subtle" | "strong" }) {
  const op = intensity === "subtle" ? 0.12 : intensity === "strong" ? 0.28 : 0.2
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <div
        className="absolute inset-0"
        style={{
          background: `radial-gradient(ellipse 70% 45% at 80% 100%, rgba(34, 211, 238, ${op * 0.55}), transparent 50%)`,
        }}
      />
      <div
        className="absolute inset-0"
      ...
      />
      <div className="absolute top-[-200px] left-1/2 h-[520px] w-[900px] -translate-x-1/2 rounded-full bg-purple-500/[0.07] blur-[120px]" />
      <div className="absolute bottom-[-240px] left-1/2 h-[560px] w-[780px] -translate-x-1/2 rounded-full bg-cyan-500/[0.06] blur-[140px]" />
