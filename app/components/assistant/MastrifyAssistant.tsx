...
export default function MastrifyAssistant() {
  ...
  return (
    <div className="pointer-events-none fixed bottom-[max(7.75rem,calc(7.75rem+env(safe-area-inset-bottom)))] right-[max(4.5rem,calc(4.5rem+env(safe-area-inset-right)))] z-[70] flex flex-col items-end max-md:max-w-[calc(100vw-5.5rem)] md:bottom-[3.25rem] md:right-[4.5rem]">
      <AnimatePresence>
        {open ? (
          <motion.div
            key="chat"
