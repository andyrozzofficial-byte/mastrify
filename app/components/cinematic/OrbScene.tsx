 ...
 */
export default function OrbScene({ activeStep, scrollSafe = false, orbMode = "auto" }: Props) {
  return (
    <div className="marketing-hero-orb-slot marketing-hero-visual marketing-hero-visual-slot hidden min-w-0 shrink-0 items-center justify-center md:flex">
      <HeroEngineOrb activeStep={activeStep} compactAtmosphere scrollSafe={scrollSafe} mode={orbMode} />
    </div>
  )
}
