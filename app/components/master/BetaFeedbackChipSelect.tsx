        ...
        {options.map((opt) => {
          ...
          return (
            <button
              ...
              className={`flex min-h-[2.25rem] items-center justify-center rounded-lg border px-2 py-1.5 text-center text-[11px] font-semibold leading-tight transition sm:min-h-[2.35rem] sm:text-[12px] ${
                active
