...
const MarketingHeroOrb = forwardRef<HTMLDivElement, MarketingHeroOrbProps>(
  function MarketingHeroOrb({ activeStep, className = "" }, ref) {
    ...
    return (
      <motion.div
        ref={ref}
        className={[
          "marketing-hero-orb marketing-hero-orb-slot hidden md:flex marketing-hero-visual relative mx-auto w-full min-w-0 max-w-full justify-center overflow-visible lg:justify-start lg:overflow-visible",
          className,
        ]
          .filter(Boolean)
          .join(" ")}
