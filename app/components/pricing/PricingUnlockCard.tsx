    ...
    >
      ...
      <div className="relative overflow-hidden rounded-[1.35rem] border border-white/[0.11] bg-gradient-to-b from-white/[0.05] to-black/[0.78] p-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_0_0_1px_rgba(167,139,250,0.1),0_24px_56px_rgba(0,0,0,0.48)] backdrop-blur-2xl md:p-10">
        ...
        <div className="relative text-center">
          ...
          <Link
            href="/master"
            className="group/btn relative mx-auto mt-8 inline-flex min-h-[50px] min-w-[13.5rem] items-center justify-center overflow-hidden rounded-xl bg-gradient-to-b from-violet-500/95 via-indigo-600/95 to-indigo-800/95 px-9 text-[15px] font-semibold text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.11),0_16px_40px_rgba(0,0,0,0.31),0_0_28px_rgba(99,102,241,0.10)] ring-1 ring-white/[0.1] transition-[filter,box-shadow] duration-300 hover:brightness-[1.03] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.14),0_18px_44px_rgba(0,0,0,0.34),0_0_28px_rgba(99,102,241,0.10)] md:mt-9"
          >
            <span
