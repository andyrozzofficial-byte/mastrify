-- Ensure beta_reported_issues exists for the Issues admin page.
...
create index if not exists beta_reported_issues_user_id_idx on public.beta_reported_issues (user_id);
create index if not exists beta_reported_issues_reporter_email_idx on public.beta_reported_issues (reporter_email);
create index if not exists beta_reported_issues_status_idx on public.beta_reported_issues (status);
